 ...
 */
public class Ch9_11_OptionDialogTest {
...
class OptionDialogFrame extends JFrame {
    public OptionDialogFrame() {
        ...
        messageTypePanel = new ButtonPanel("Message Type", "ERROR_MESSAGE", "INFORMATION_MESSAGE", "WARNING_MESSAGE", "QUESTION_MESSAGE",
                "PLAIN_MESSAGE");
    ...
    public Object[] getOptions() {
        ...
        if (s.equals("String[]"))
            ...
            return new Icon[] { new ImageIcon("src/corejava.corejava1/ch9/yellow-ball.gif"), new ImageIcon("src/corejava.corejava1/ch9/blue-ball.gif"),
                    new ImageIcon("src/corejava.corejava1/ch9/red-ball.gif") };
        else if (s.equals("Object[]"))
            return new Object[] { messageString, messageIcon, messageComponent, messageObject };
        else
            return null;
        ...
        public void actionPerformed(ActionEvent event) {
            if (typePanel.getSelection().equals("Confirm"))
                ...
                if (inputPanel.getSelection().equals("Text field"))
                    ...
                    JOptionPane.showInputDialog(OptionDialogFrame.this, getMessage(), "Title", getType(messageTypePanel), null, new String[] {
                ...
                JOptionPane.showOptionDialog(OptionDialogFrame.this, getMessage(), "Title", getType(optionTypePanel), getType(messageTypePanel),
    ...
    private Icon            messageIcon      = new ImageIcon("src/corejava.corejava1/ch9/blue-ball.gif");
