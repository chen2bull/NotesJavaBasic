package corejava.corejava2.ch04.ldap;
import java.awt.*;
...
class LDAPFrame extends JFrame
{
   ...
   public static DirContext getContext() throws NamingException, IOException
   {
      ...
      FileInputStream in = new FileInputStream("/src/corejava.corejava2/ch04/ldap/ldapserver.properties");
      props.load(in);
      in.close();
